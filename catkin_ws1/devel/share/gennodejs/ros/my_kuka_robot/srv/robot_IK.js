...
class robot_IKRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_IKRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_IKRequest
    let len;
    let data = new robot_IKRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_IKRequest(null);
...
class robot_IKResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type robot_IKResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type robot_IKResponse
    let len;
    let data = new robot_IKResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_IKResponse(null);
...
module.exports = {
  Request: robot_IKRequest,
  Response: robot_IKResponse,
  md5sum() { return 'e2841ca7335735bd34d77773a974ca4b'; },
  datatype() { return 'my_kuka_robot/robot_IK'; }
};
